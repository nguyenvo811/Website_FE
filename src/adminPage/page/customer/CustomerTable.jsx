...
import { getCustomers, removeCustomer } from "../../../api/apiServices";
  ...
  const removeRow = () => {
	...
	return (
		<>
			...
			<UpdateCustomer open={openUpdate} close={() => setOpenUpdate(false)} row={updateRow} data={rows} setData={setRows} />
			<AlertCustomer open={openAlert} close={() => setOpenAlert(false)} handleRemove={() => removeRow()}/>
		</>
	)
}
