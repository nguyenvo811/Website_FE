...
import { getContacts, removeContact } from "../../../api/apiServices";
...
const Table = function() {
  ...
  const removeRow = () => {
    ...
    { field: 'contactName', headerName: 'Tên nhân viên', width: 200, },
		{ field: 'numberPhone', headerName: 'Số điện thoại' },
	...
	return (
		<>
			...
			<AddContact open={open} close={() => setOpen(false)} row={updateRow} />
			<UpdateContact open={openUpdate} close={() => setOpenUpdate(false)} row={updateRow} data={rows} setData={setRows} />
			<AlertContact open={openAlert} close={() => setOpenAlert(false)} handleRemove={() => removeRow()}/>
		</>
	)
}
